...
for (let item of cars) {
    ...
    document.write(`
        <div class="item" style="background: ${item.additional.isTurbo ? "rgb(0, 200, 200)" : ""}">
            ...
            <h2 class="red" style="display: ${item.additional.hasLuke ? "block;" : "none;"}">Has luke</h2>
            <h2 class="red" style="display: ${item.additional.onGas ? "block;" : "none;"}">Has Gas</h2>
       </div>
        `)
}
